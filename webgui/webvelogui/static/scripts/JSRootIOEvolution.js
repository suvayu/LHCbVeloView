   ...
   JSROOTIO.RootFile = function(url) {
      ...
      JSROOTIO.RootFile.prototype.ReadStreamerInfo = function() {
         ...
         var callback1 = function(file, buffer) {
            ...
            displayListOfKeys(file.fKeys);//uncoment and put ,'#status' in parantesses to get status field back
            delete buffer;
            buffer = null;
...
//      console.log("!!!We are in JSROOTIO before return"); 
//      JSROOTIO.myCounter = true; 
